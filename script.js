...
function isTheFieldEmpty(inputField, helpId){
    return editNodeText(/^[A-Za-z\.\' \-]{1,15}\s?[A-Za-a\.\' \-] {1,15}\s?[A-Za-a\.\' \-] {1,15}/, inputField.value, helpId, "Please enter a valid name");
}
// Exception Handling 1:34:54
